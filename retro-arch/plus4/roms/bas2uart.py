...
a binary file of bytes to be injected into the Plus/4 via UART.  Each
...
def convert(infile, outfile):
    ...
    for line in lines:
        ...
        if not line:
            continue
        # Convert to LOWERCASE — the keyboard mapper treats lowercase
        # ASCII as unshifted keys, which produce uppercase on screen.
