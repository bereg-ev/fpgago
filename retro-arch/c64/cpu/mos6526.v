...
module mos6526 (
  ...
  // fpgago local mod: combinational read data for CPUs whose effective
  // address is only valid on the consuming clock tick (Arlet 6502).
  // Mirrors the registered db_out mapping; rd still fires the read side
  // effects (ICR clear, TOD latch) at the same tick.
  output reg  [7:0] db_out_live,
...
always @* begin
  case (rs)
    4'h0: db_out_live = pa_in;
    4'h1: db_out_live = pb_in;
    4'h2: db_out_live = ddra;
    4'h3: db_out_live = ddrb;
    4'h4: db_out_live = timer_a[ 7:0];
    4'h5: db_out_live = timer_a[15:8];
    4'h6: db_out_live = timer_b[ 7:0];
    4'h7: db_out_live = timer_b[15:8];
    4'h8: db_out_live = {4'h0, tod_latch[3:0]};
    4'h9: db_out_live = {1'b0, tod_latch[10:4]};
    4'ha: db_out_live = {1'b0, tod_latch[17:11]};
    4'hb: db_out_live = {tod_latch[23], 2'h0, tod_latch[22:18]};
    4'hc: db_out_live = sdr;
    4'hd: db_out_live = {~irq_n, 2'b00, icr};
    4'he: db_out_live = {cra[7:5], 1'b0, cra[3:0]};
    4'hf: db_out_live = {crb[7:5], 1'b0, crb[3:0]};
  endcase
end
