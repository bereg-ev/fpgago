...
#   CPU:    6502 already in repo (retro-arch/common/cpu/6502), wrapped as 6510 here
...
echo "    VIC-II: retro-arch/c64/vic/"
echo "    SID:    retro-arch/c64/sid/"
echo "    CIA:    retro-arch/c64/cpu/mos6526.v"
echo "    CPU:    6502 in retro-arch/common/cpu/6502/ (wrapped as 6510)"
echo ""
