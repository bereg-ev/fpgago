/*
 * platforms/sdl2/main.c — SDL2 entry point for Tic-Tac-Toe.
 *
 * Pumps SDL events, maps keys to game_tick() input chars, repaints on input.
 * All HAL plumbing lives in hal_sdl2.c.
 */
...
int main(int argc, char *argv[])
{
    ...
    if (hal_sdl2_init("Tic-Tac-Toe") != 0) {
