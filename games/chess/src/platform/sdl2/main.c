/*
 * platform/sdl2/main.c — SDL2 platform for Chess
 *
 * Provides pixel HAL (hal_clear, hal_fill_rect, hal_swap) via a u16
 * software framebuffer uploaded to an SDL2 streaming texture (RGB565).
 *
 * Input: WASD/arrows = move cursor, Space = select/place, ESC = quit.
 */
