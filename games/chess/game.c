...
#include "memmap.h"
/* Fixed external-RAM addresses (gcasm has no .bss support; PSRAM on HW=v2).
 * Game state at MEM_EXT_RAM_BASE; zobrist tables 64KB above it.
 * Layout (offsets from MEM_EXT_RAM_BASE):
 *   0x10000 zob_piece[64][15]   (3840 bytes)
 *   0x10F00 zob_side
 *   0x10F04 zob_castle[16]
 *   0x10F44 zob_ep[8]
 *   0x10F64 zob_ready                                                   */
#define ZOB_BASE   (MEM_EXT_RAM_BASE + 0x10000u)
#define zob_piece  ((unsigned int(*)[15])(ZOB_BASE + 0x000u))
#define zob_side   (*(unsigned int*)(ZOB_BASE + 0xF00u))
#define zob_castle ((unsigned int*)(ZOB_BASE + 0xF04u))
#define zob_ep     ((unsigned int*)(ZOB_BASE + 0xF44u))
#define zob_ready  (*(int*)(ZOB_BASE + 0xF64u))
#else
